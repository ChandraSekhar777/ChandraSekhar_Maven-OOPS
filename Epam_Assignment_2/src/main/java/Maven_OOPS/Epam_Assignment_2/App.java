package Maven_OOPS.Epam_Assignment_2;
...
public class App
{
	...
	private static final Jalebi Jalebi1 = new Jalebi("type1", 10, 10);
	private static final Jalebi Jalebi2 = new Jalebi("type2", 15, 15);
	private static final Jalebi Jalebi3 = new Jalebi("type3", 25, 20);
	private static final mysorepak mysorepak1 = new mysorepak("Type1", 10, 50);
	private static final mysorepak mysorepak2 = new mysorepak("Type2", 20, 50);
